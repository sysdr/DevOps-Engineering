...
kind load docker-image frontend:latest --name istio-demo
...
for service in user-service product-service order-service recommendation-service-v1 recommendation-service-v2 frontend; do
...
log "✅ Istio Service Mesh is ready!"
log ""
